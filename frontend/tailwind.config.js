...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-purple': 'linear-gradient(to right, var(--beacon-purple), var(--beacon-purple-dark))',
        'gradient-purple-reverse': 'linear-gradient(to right, var(--beacon-purple-dark), var(--beacon-purple))',
        'gradient-purple-vertical': 'linear-gradient(to bottom, var(--beacon-purple), var(--beacon-purple-dark))',
      },
      fontFamily: {
