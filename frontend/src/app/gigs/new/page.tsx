            ...
            <SimplifiedLayout userType="client" showSearch={true} searchPlaceholder="Search...">
                <div className="container mx-auto px-4 py-8">
                    <div className="flex justify-center items-center h-64">
                        <EnhancedLoadingSpinner size="lg" message="Creating gig..." />
                    </div>
                </div>
            </SimplifiedLayout>
        )
        ...
        <SimplifiedLayout userType="client" showSearch={true} searchPlaceholder="Search...">
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-3xl mx-auto">
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-neutral-900">Create New Gig</h1>
                        <p className="text-neutral-600 mt-2">
                            Post a new gig and start connecting with creative professionals
                        </p>
                    </div>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Describe your gig in detail. Include goals, requirements, and any specific deliverables..."
                                        />
                                        {errors.description && (
