...
export default function MyGigsClientPage() {
        ...
        const fetchGigs = async () => {
            try {
                ...
                if (token) {
                    ...
                    const gigsResp = await fetch(`${apiBase}/gigs/my-gigs?skip=${skip}&limit=${limit}`, {
                        method: 'GET',
                        headers: {
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6 mb-8">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-neutral-600 mt-2">Manage your gigs and track their progress.</p>
                            </div>
