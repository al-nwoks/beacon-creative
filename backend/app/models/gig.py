...
class Gig(Base):
    ...
    status = Column(
        Enum("draft", "active", "hired", "completed", "cancelled", name="gig_status"),
        default="active",
        nullable=False
    )
    ...
    # Relationships
    client = relationship("User", foreign_keys=[client_id], backref="created_gigs")
    hired_creative = relationship("User", foreign_keys=[hired_creative_id], backref="hired_gigs")
